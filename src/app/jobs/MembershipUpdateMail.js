...
class MembershipUpdateMail {
  get key() {
    return 'MembershipUpdateMail';
  }
  ...
  async handle({ data }) {
    ...
    await Mail.sendMail({
      ...
      subject: 'Subscripção atualizada',
      template: 'membershipTemplates/membershipUpdated',
      context: {
...
export default new MembershipUpdateMail();
